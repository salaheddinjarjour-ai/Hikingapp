    ...
    <div className="flex h-full min-h-screen w-full max-w-md flex-col bg-background-dark shadow-2xl">
      <div className="flex-1 flex flex-col px-6 pt-8 pb-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-base">Resume your adventure where you left off.</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div className="flex justify-end">
            <button type="button" className="text-primary hover:text-green-400 text-sm font-semibold transition-colors">
              Forgot Password?
            </button>
          </div>
        ...
        <div className="relative py-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-background-dark text-gray-400 font-medium">Or continue with</span>
          </div>
        </div>

        <div className="grid grid-cols-3 gap-4 mb-8">
          <button
            className="flex h-14 w-full items-center justify-center rounded-xl border border-white/20 bg-surface-dark hover:bg-surface-light transition-colors"
          ...
          <button
            className="flex h-14 w-full items-center justify-center rounded-xl border border-white/20 bg-[#FC4C02] hover:bg-[#E34300] transition-colors text-white"
